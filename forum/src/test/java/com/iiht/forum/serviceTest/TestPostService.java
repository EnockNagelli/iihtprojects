...
public class TestPostService 
{
	 ...
	 * -----------------------------------------------------
	 * 
	 * @Test public void testViewAllPostsImpl1() throws Exception { VisitorPostsDto
	 * value = MasterData.getPostDtoDetails(); VisitorPosts posts = new
	 * VisitorPosts((long)10, "World Sport", "Cricket",
	 * "This Sport is played around the Globe...");
	 ...
	 * yakshaAssert(currentTest(), postFromdb==value ? true : false,
	 * businessTestFile); }
	 */	  
	//--------------------------------------------------------------------------------------------------------------------------------
	@Test 
	 ...
	 * -----------------------------------------------------
	 * 
	 * @Test public void testViewAllPostsImpl3() throws Exception {
	 * when(postService.getVisitorPostsDto(new VisitorPosts())).thenReturn(null);
	 * VisitorPostsDto postFromdb =
	 * postService.getPostById(visitorPostDto.getPostId());
	 * yakshaAssert(currentTest(), postFromdb==null ? true : false,
	 * businessTestFile); }
	 */
}