...
public interface CommentRepository extends JpaRepository<VisitorComments, Long>
{
	...
	public VisitorComments findVisitorCommentsById(Long postId);

	@Query("delete FROM VisitorComments de WHERE de.postId=?1")
	public Integer deleteCommentById(Long postId);
}